 ...
 **0. You need an origional ES-E1 hardware.**  
 ...
 4.Download and Copy the ['patcher'](https://github.com/MitsuhaQuQ/Canon_ES-E1_patch/releases/tag/main) into the program folder where the Remote.exe and Memory.exe lives.  
 5.Run the patcher.  
